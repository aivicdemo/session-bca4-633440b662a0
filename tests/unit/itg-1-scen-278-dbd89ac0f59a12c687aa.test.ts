...
describe('SCEN-278: 連続未提出日数が3日以上の場合、高優先度でエスカレーション方法を提案する', () => {
  it('should return high priority escalation when consecutive miss count is 3 or more', async () => {
    ...
    expect(result.suggestedPromptMessage).toContain('連続');
