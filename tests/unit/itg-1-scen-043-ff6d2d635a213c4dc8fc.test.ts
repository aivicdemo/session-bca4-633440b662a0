...
describe('SCEN-043: 催促メール送信に一部失敗した場合', () => {
  ...
  it('sendNonSubmissionPromptNotificationの一部失敗時、executionStatusはpartial_failureになる', async () => {
    ...
    const promptError = result.errors?.find((e) => e.code === 'PromptNotificationSendingFailed');
